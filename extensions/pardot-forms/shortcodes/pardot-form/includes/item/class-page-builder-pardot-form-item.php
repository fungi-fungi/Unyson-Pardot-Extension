...
class Page_Builder_Pardot_Form_Item extends Page_Builder_Item {
	public function get_type() {
		return 'pardot-form';
	}

	private function get_shortcode_options() {
		$shortcode_instance = fw()->extensions->get( 'shortcodes' )->get_shortcode( 'pardot-form' );
	...
	public function enqueue_static() {
		 ...
		 */
		$cf_shortcode = fw()->extensions->get( 'shortcodes' )->get_shortcode( 'pardot-form' );
	...
	protected function get_thumbnails_data() {
		 ...
		 */
		$shortcode = fw_ext( 'shortcodes' )->get_shortcode( 'pardot-form' );
...
FW_Option_Type_Builder::register_item_type( 'Page_Builder_Pardot_Form_Item' );
